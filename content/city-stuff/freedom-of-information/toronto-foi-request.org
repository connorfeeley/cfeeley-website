...
The system is *really* great, in a lot of ways.

But that isn't the point of this article - the point of this article is exploring the ways it *isn't*.
...
There appear to be two models in use:
- [[https://www.pbsc.com/products#eFit][E-Fit]] and what's referred to as "E-Fit G5" (which appears to simply be a newer version of the E-Fit).
